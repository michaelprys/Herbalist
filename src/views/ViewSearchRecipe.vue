    ...
    <div class="section">
        <div class="container">
            <label class="section__search">
                ...
                <router-link class="section__icon-search" to="/">
                    <svg
            ...
            <ul class="section__list" v-if="keyword !== ''">
                <li v-for="result in recipe" :key="result.recipe_id">
                    <router-link
                        class="section__suggestion"
                        :to="{
                            name: 'recipe-detail',
                            params: {
                                recipe: result.title,
                        ...
                        <svg
                            class="section__icon-suggestion"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24">
